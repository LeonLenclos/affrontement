...
* **Jouer une technique de base**
* **Jouer une carte**
* **Jouer une intervention**
...
Les techniques de bases sont des techniques que l'on peut jouer sans utiliser de carte. Elles sont au nombre de 5 :
...
Lorsqu'un joueur joue une carte, il la pose depuis sa **main** dans sa **zone d'activité** le temps d'effectuer ses étapes. une fois que toutes les étapes sont passées, il la place dans son **historique**.

### Jouer une intervention


### Jouer les étapes d'une carte ou d'une technique de base

**On effectue les étapes une à une, de haut en bas.**

Les étapes peuvent être de quatre sortes :
...
Si une étape est une **condition** il faut respecter la condition pour passer à l'étape suivante. Si la condition n'est pas respectée, la carte va directement dans l'historique, on ignore les étapes suivantes et c'est la fin du tour.
